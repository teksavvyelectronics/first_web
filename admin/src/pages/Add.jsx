...
const Add = ({token}) => {
  ...
  <div className="flex items-center gap-2 mb-4">
    ...
    />
    <label htmlFor="hasSizes">Custom size options</label>
  </div>
    ...
    <div className="space-y-4">
        ...
        <button 
          ...
          onClick={() => {
            if (customSizeInput.trim()) {
              setSizes(prev => [...new Set([...prev, customSizeInput.trim()])]);
              setCustomSizeInput('');
            }
          }}
      ...
      <div className="flex flex-wrap gap-2">
        {sizes.map((size, index) => (
          <div key={index} className="bg-pink-100 px-3 py-1 rounded flex items-center gap-2">
            <span>{size}</span>
            <button 
              type="button"
